...
public interface RpcDrawingService {
...
//    method 是"CNN"或者“lstm”
//    """
//    pred=1.0 #pred -> float
//    return pred

    float predStockReturn(String stockCode, String date, String method);
...
//    return pred
    ...
    float predStockVol(String stockCode, String date);
...
//    return pred
    ...
    float predPortfolioReturn(List<String> portfolio, List<Integer> shares, String date, String method);
...
//    return pred
    ...
    float predPortfolioVar(List<String> portfolio, List<Integer> shares, String date);
...
//    返回值已转成json格式
    ...
    String portfolioHistoryReturn(List<String> portfolio, List<Integer> shares, String startDate, String endDate);
...
//    return dates,vols
//    //    返回值已转成json格式
    String portfolioHistoryVol(List<String> portfolio, List<Integer> shares, String startDate, String endDate);
}
